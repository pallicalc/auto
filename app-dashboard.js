...
async function startVisibleOfflineDownload() {
    ...
    const ASSET_CACHE_NAME = 'pallicalc-smart-v64'; 
    ...
    const filesToDownload = [
      ...
      './education/td-fentanyl/1.jpg', './education/td-fentanyl/2.jpg', './research.html', './diagnostic/ohat.html', './js/html2canvas.min.js','./diagnostic/cods.html', './diagnostic/sxi.html', './generate.html', './js/html5-qrcode.min.js'
    ];
